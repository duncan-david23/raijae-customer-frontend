    ...
    try {
      ...
      if (error) {
        ...
        if (error.message.includes('Invalid login credentials')) {
          ...
          setMsg('Please confirm your email address before signing in. Check your inbox for the confirmation link.')
        } else {
    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ── left panel (form side for login — reversed) ── */
        .rj-form-side {
          display: flex;
          ...
          <AnimatePresence mode="wait">
            ...
            {submitted ? (
              ...
              >
                ...
                <p style={{ fontSize: '13px', color: '#888', lineHeight: 1.7, maxWidth: '240px' }}>
                  You're signed in. Redirecting you to the shop...
                </p>
                <motion.button
              ...
              >
                ...
                <form onSubmit={handleSubmit} noValidate>
                  ...
                  {/* Password */}
                  <motion.div variants={fadeUp} custom={2} style={{ marginBottom: errors.password ? '4px' : '16px' }}>
                    <div className="rj-field">
                      <input
                  ...
                  <motion.div
                    variants={fadeUp}
                    custom={3}
                    style={{ textAlign: 'right', marginBottom: '36px' }}
                  >
                    <motion.a
                      ...
                      whileHover={{ color: '#111', borderBottomColor: '#111' }}
        ...
        <div className="rj-panel">
          ...
          >
            ...
            <p style={{
              ...
              "Good taste is the one luxury that never goes out of style."
            </p>
